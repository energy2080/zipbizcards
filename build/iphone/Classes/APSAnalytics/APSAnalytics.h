 ...
 * to send analytic data that can be viewed on the zipbizcards Dashboard.
 *
 * For information on getting started with zipbizcards Platform Services,
 * see [zipbizcards Platform Services for iOS](http://bit.ly/1kqteQS).
 */
