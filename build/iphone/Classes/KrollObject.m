...
//@interface zipbizcardsObject : NSObject
//@end

@interface zipbizcardsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[zipbizcardsObject class]]) {
      for (NSString *key in [[(zipbizcardsObject *)o modules] allKeys]) {
