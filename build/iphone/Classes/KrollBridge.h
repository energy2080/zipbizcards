...
@interface zipbizcardsObject : KrollCoverageObject {
#else
@interface zipbizcardsObject : KrollObject {
#endif
  @private
...
extern NSString *zipbizcards$ModuleRequireFormat;
...
@interface KrollBridge : Bridge <TiEvaluator, KrollDelegate> {
  ...
  zipbizcardsObject *_zipbizcards;
  KrollObject *console;
  BOOL shutdown;
