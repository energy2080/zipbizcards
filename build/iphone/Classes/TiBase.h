...
// in simulator we redefine to format for zipbizcards Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.zipbizcards." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.zipbizcards";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIzipbizcardsNativeItemNone = -1,
  UIzipbizcardsNativeItemSpinner = -2,
  UIzipbizcardsNativeItemProgressBar = -3,

  UIzipbizcardsNativeItemSlider = -4,
  UIzipbizcardsNativeItemSwitch = -5,
  UIzipbizcardsNativeItemMultiButton = -6,
  UIzipbizcardsNativeItemSegmented = -7,

  UIzipbizcardsNativeItemTextView = -8,
  UIzipbizcardsNativeItemTextField = -9,
  UIzipbizcardsNativeItemSearchBar = -10,

  UIzipbizcardsNativeItemPicker = -11,
  UIzipbizcardsNativeItemDatePicker = -12,

  UIzipbizcardsNativeItemInfoLight = -13,
  UIzipbizcardsNativeItemInfoDark = -14,

  UIzipbizcardsNativeItemDisclosure = -15,

  UIzipbizcardsNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all zipbizcards instances of
