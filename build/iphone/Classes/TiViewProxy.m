...
- (TiBlob *)toImage:(id)args
{
  ...
  TiThreadPerformOnMainThread(^{
    ...
    if (callback != nil) {
      DebugLog(@"[DEBUG] Since zipbizcards SDK 7.0.0, the toImage callback returns a single blob on iOS to match the Android / Windows behavior.");
      DebugLog(@"[DEBUG] Please migrate your code in case you still use the old behavior. This debug-log will be removed in zipbizcards SDK 8.0.0");
