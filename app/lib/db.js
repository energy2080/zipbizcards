exports.db = function() {
	...
	//conn.execute('DELETE FROM favorites'); //This will delete all data from our table - probably wouldn't do this in production ;)
	...
	api.getAllCards = function() {
		...
		api.close();
		return results;
		//return an array of JavaScript objects reflecting the favorite
	};
